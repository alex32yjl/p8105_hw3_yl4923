...
```
Most of states appears a relatively constant average _data_value_ over the eight year period while state AK in red line is the one deviates the most in 2005 and 2009.
...
acc_df %>%
  ...
  knitr::kable(caption = "Total physical activity over the day",
               align = "lccrr")
```
